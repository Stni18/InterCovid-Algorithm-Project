	...
	public class InterCovidData3 {
		...
		static int NodeA[] = new int [10000];
		static int NodeB[] = new int [10000];
		 
		//Parses calculated distances of the three groups
		static double Center_1[] = new double[10000];
		static double Center_2[] = new double[10000];
		static double Center_3[] = new double[10000];
		static double distance = 0;
		static int select = 0;
		
		static double temp[] = new double[10000]; //will be used to store A[i] of previous iteration
		static double A[] = new double[10000];
		
		//Temporarily stores distances
		static double x1_D1[] = new double[10000];
		static double y1_D1[] = new double[10000];
		static double w1_D1[] = new double[10000];
		static double z1_D1[] = new double[10000];
		static double g1_D1[] = new double[10000];
		...
		static double Init_x1_D1[] = new double[10000];
		static double Init_y1_D1[] = new double[10000];
		static double Init_w1_D1[] = new double[10000];
		static double Init_z1_D1[] = new double[10000];
		static double Init_g1_D1[] = new double[10000];
		
		//Dimensions for Group 1
		static double x1_G1[] = new double[10000];
		static double y1_G1[] = new double[10000];
		static double w1_G1[] = new double[10000];
		static double z1_G1[] = new double[10000];
		static double g1_G1[] = new double[10000];
		
		//Dimensions for Group 2
		static double x1_G2[] = new double[10000];
		static double y1_G2[] = new double[10000];
		static double w1_G2[] = new double[10000];
		static double z1_G2[] = new double[10000];
		static double g1_G2[] = new double[10000];
		
		//Dimensions for Group 3
		static double x1_G3[] = new double[10000];
		static double y1_G3[] = new double[10000];
		static double w1_G3[] = new double[10000];
		static double z1_G3[] = new double[10000];
		static double g1_G3[] = new double[10000];
		
		
		//keeps count of iterations for Data3.txt
		...
		public static void Distance1() throws FileNotFoundException 
		{
			...
			while(inputStream.hasNext() && x < 100)
			{		
				...
				//Initialize centers with random lines from the file Data3.txt
		...
		{
			double Center1[] = new double[10000];
			double Center2[] = new double[10000];
			double Center3[] = new double[10000];
		...
		public static void Average() throws FileNotFoundException
		{
			...
			{	
				...
				//Breaks loop if equal to last iteration
				if(condition == true)
				{
					break;
				}
		...
		public static void Accuracy() throws FileNotFoundException
		{
			...
			if(equals == true)
			{
				...
				System.out.println("The accuracy of Data3.txt is: " + accuracy);
